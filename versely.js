...
var $author$project$Versely$scriptureDecoder = A3(
	...
	A3(
		...
		A3(
			...
			'reference',
			$elm$json$Json$Decode$string,
			$elm$json$Json$Decode$succeed($author$project$Versely$Scripture))));
var $author$project$Versely$fetchScripture = function (search) {
	return $elm$http$Http$get(
		{
			expect: A2($elm$http$Http$expectJson, $author$project$Versely$LoadScripture, $author$project$Versely$scriptureDecoder),
...
var $author$project$Versely$matchingBooks = F2(
	function (searchText, books) {
		return A2(
